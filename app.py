...
greeted_users = set()            # フォローアップ前に案内済み
released_users = set()           # フォローアップ後に通常チャットへ移行したユーザー
...
def send_followup(uid):
    ...
    combined_text = (
        ...
        "下記より処方のお手続きにお進みください。\n\n"
        "なお、処方計画は次のとおりです。この計画にもとづき、継続的に医療用医薬品をお届けします。\n\n"
        "１クール　30日分\n"
